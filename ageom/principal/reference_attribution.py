...
from ageom.principal.eval_spec import compute_evaluation_payload, load_evaluation_spec
    ...
    for node in tree.body:
        ...
        for inner in ast.walk(node):
            if not isinstance(inner, ast.Call):
                continue
            if not isinstance(inner.func, ast.Name) or inner.func.id != "_ageom_probe":
                continue
