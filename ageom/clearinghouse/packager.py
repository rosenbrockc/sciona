...
from ageom.clearinghouse.models import SandboxPayload
...
def package_cdg(
    ...
    *,
    ...
    ageom_yml
        Parsed ageom.yml dataset specification.
    config_yml
...
def create_sandbox_tarball(payload: SandboxPayload) -> bytes:
    ...
    with tarfile.open(fileobj=buf, mode="w:gz") as tar:
        ...
        _add_json(tar, "ageom.yml", payload.ageom_yml)
