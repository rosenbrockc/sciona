...
_KEYWORD_RULES: list[tuple[list[str], ConceptType]] = [
    ...
    (["sqrt", "irrational", "real", "limit", "continu", "deriv", "integral",
      "mean_value", "taylor", "cauchy", "convergent", "monotone", "bounded"],
     ConceptType.ANALYSIS),
    (["algebra", "polynomial", "ring", "field", "group", "linear", "eigenvalue",
      "matrix", "vector", "fundament.*algebra", "hermite"],
     ConceptType.ALGEBRA),
    (["triangle", "circle", "angle", "area", "polygon", "pythagor", "desargues",
      "feuerbach", "heron", "isosceles"],
     ConceptType.GEOMETRY),
    (["combinat", "binomial", "pigeon", "ramsey", "partition", "permutation",
      "ballot", "derangement", "catalan"],
