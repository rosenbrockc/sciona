...
def generate_pipeline_py(
    ...
    *,
    ...
    lines.append("")
    lines.append("def _reduce_adapter_template(template: dict[str, Any], entrypoint: str | None) -> tuple[dict[str, Any], tuple[str, ...]]:")
    ...
    lines.append("    template, selected_groups = _reduce_adapter_template(template, entrypoint)")
