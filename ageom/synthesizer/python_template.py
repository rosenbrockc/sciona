...
def generate_pipeline_py(
    ...
    *,
    ...
    lines.append("            if (str(column) == 'value' or alias == 'value') and 'signal' not in flat and any(token in group_lower for token in ('signal', 'ecg', 'ppg', 'wave')):")
    lines.append("                flat['signal'] = value")
