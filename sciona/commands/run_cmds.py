...
def _build_signal_event_rate_cdg(goal: str, prover: "Prover"):
    ...
    from sciona.architect.skeletons import get_skeleton, infer_boundary_ports, instantiate_skeleton
...
def _build_rapid_direct_cdg(
    ...
    from sciona.services import build_direct_goal_cdg
...
async def _run_rapid_direct_match(
    ...
    *,
    ...
    from sciona.services import HunterBatchMatchRequest, HunterDirectMatchRequest, HunterService
...
async def _run_structured_single_pass(
    ...
    *,
    ...
    from sciona.architect.handoff import to_pdg_nodes
    from sciona.orchestrator import OrchestratorResult
    from sciona.services import HunterBatchMatchRequest, HunterService
