"""Full pinned competition Inception-v4, including its inference auxiliary head.
...
class InceptionV4(nn.Module):
    def __init__(self):
        super().__init__()
        self.topology = json.loads(Path(__file__).with_name('adversarial_inception_v4_topology.json').read_text())
...
def build_inception_v4(*, seed, state=None):
