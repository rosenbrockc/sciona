"""Pinned SE-ResNeXt101 encoder, without model downloads.

Derived from Remi Cadene pretrainedmodels (BSD-3-Clause), vendored in
HuBMAP source commit615444e86f4fb5ab916c0b66d311a307f4e4dd27.
Copyright (c) 2017, Remi Cadene. See docs/licenses/HuBMAP-pretrainedmodels-LICENSE.txt.
Selected class bodies are unchanged apart from formatting.
"""
