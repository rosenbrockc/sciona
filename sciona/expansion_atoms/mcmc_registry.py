...
MCMC_DECLARATIONS = {
    ...
    "detect_divergent_transitions": (
        "sciona.expansion_atoms.runtime_mcmc.detect_divergent_transitions",
    ...
    "compute_dual_averaging_step_size": (
        "sciona.expansion_atoms.runtime_mcmc.compute_dual_averaging_step_size",
        "np.ndarray, float, float, float, float, float -> float",
        "Adapt HMC step size via Nesterov dual averaging.",
    ),
    "estimate_mass_matrix": (
        "sciona.expansion_atoms.runtime_mcmc.estimate_mass_matrix",
        "np.ndarray, bool -> np.ndarray",
        "Estimate mass matrix M from warmup samples.",
    ),
    "compute_convergence_diagnostics": (
        "sciona.expansion_atoms.runtime_mcmc.compute_convergence_diagnostics",
