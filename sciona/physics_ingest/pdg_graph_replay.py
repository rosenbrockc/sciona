"""Compose rational inference steps using computed intermediate equations."""
import json
from sciona.physics_ingest.pdg_rule_contracts import contract_blockers, replay_rational_step
...
def replay_derivation(nodes, expressions, rules, *, edges=None):
    ...
    return {
        'runner_version':'pdg-graph-replay.v1',
        'scope':'composed source rational algebra under explicit conditions; not physical or publication approval',
        'steps':records,
