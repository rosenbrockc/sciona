"""Contrails source BCE and Dice objectives, preserved without numerical changes.

Copyright (c) 2023 Jun Koda; MIT, see docs/licenses/Contrails-MIT.txt.
Source commit 08a15beb36f9cbed4c3990e74c625c1332b61fe8, src/unet5/losses.py.
Both final branches reference this shared source through repository symlinks.
"""
import torch
