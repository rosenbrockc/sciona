"""Five-fold Sofia combined-ROC classification and full-training query refits.

This boundary accepts raw features. Supervised feature selection is fitted inside
...
"""
import numpy as np
from sciona.otto_sofia_roc import fit_predict
