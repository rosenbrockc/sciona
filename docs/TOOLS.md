...
- `_select_policy`
  - File: `sciona/services/planner_service.py`
...
| Oracle | File | Method |
|--------|------|--------|
| `LeanEnvironment` | `sciona/judge/lean_env.py` | Lean compile/check |
| `CoqEnvironment` | `sciona/judge/coq_env.py` | Coq compile/check |
| `PythonEnvironment` | `sciona/judge/python_env.py` | importability, callability, and arity/type checks |

### Catalog and Retrieval

| Oracle | File | Method |
|--------|------|--------|
| `PrimitiveCatalog` | `sciona/architect/catalog.py` | exact/alias lookup + token confidence |
| `SkillIndex` | `sciona/architect/embedder.py` | embedding similarity over skill primitives |
| `SemanticIndexImpl` | `sciona/indexer/builder.py` | FAISS-backed declaration retrieval |
| `LexicalSemanticIndex` | `sciona/indexer/fallback_index.py` | FAISS-free lexical fallback retrieval |
