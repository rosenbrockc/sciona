...
def test_neural_network_provider_asset_includes_mined_training_operations() -> None:
    ...
    assert {operation.rule_name for operation in asset.operations} >= {
        ...
        "insert_spatiotemporal_unet_attention_before_loss",
        "insert_flow_residual_attention_before_loss",
...
def test_support_three_neural_network_expansion_rules_apply_to_training_loop() -> None:
    ...
    cases = [
        ...
        ("requires_spatiotemporal_unet_attention", "Spatio-Temporal U-Net Attention"),
        ("requires_flow_residual_attention", "Flow-Aware Residual Attention"),
