#!/usr/bin/env python3
"""Independent read-only verification of the approved vacuum_wave realization."""
import json
...
if __name__ == '__main__':
    ...
    result = verify(root)
    (root/'docs/reviews/vacuum_wave_catalog_verification.json').write_text(json.dumps(result, indent=2, default=str)+'\n')
