#!/usr/bin/env python3
"""Independent read-only verification of the approved two-body realization."""
import json
...
from sciona.physics_ingest.two_body_execution import SOURCE_VERSION, SOURCE_HASH, build_two_body_execution
...
if __name__ == '__main__':
    ...
    result = verify(root)
    (root/'docs/reviews/two_body_catalog_verification.json').write_text(json.dumps(result, indent=2, default=str)+'\n')
