...
def main():
    ...
    cache = Path('/private/tmp/sciona_cassava_publisher_wheels')
    def acquire(item):
        name, details = item
    ...
    Path('docs/reviews/competition_aptos_wheel_acquisition.json').write_text(json.dumps(report, indent=2) + '\n')
