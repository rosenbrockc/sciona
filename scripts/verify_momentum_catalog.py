#!/usr/bin/env python3
"""Independent read-only verification of the approved momentum realization."""
import json
...
from sciona.physics_ingest.momentum_execution import SOURCE_VERSION, SOURCE_HASH, build_momentum_execution
...
if __name__ == '__main__':
    ...
    result = verify(root)
    (root/'docs/reviews/momentum_catalog_verification.json').write_text(json.dumps(result, indent=2, default=str)+'\n')
